            ...
            >
                ...
                <div className="flex justify-between p-3">
                  <div>
                    <button
                      ...
                      className="text-sm xl:text-xl p-1 xl:p-4 w-24 h-[30px] xl:w-36 xl:h-16 bg-blue-500 hover:bg-blue-700 text-white font-bold  rounded-full"
                    >
                      Watch now
                    </button>
                  </div>
                  <div>
                    <button
                      href="#"
                      className="text-sm xl:text-xl p-1 xl:p-4 w-24 h-[30px] xl:w-36 xl:h-16 bg-slate-800 hover:bg-blue-700 text-white  rounded-full"
                    >
                      Trailer
                    </button>
                  </div>
              ...
              <div className="w-full h-auto m-0 xl:relative">
                <div className="flex justify-center  xl:absolute xl:right-0 gap-x-1">
                  <SlideShowThumb
                  // movies={slideCtx.slideshowMovies}
                  // changeMovieHandler={slideCtx.changeMovieHandler}
                  />
                </div>
              </div>
            </div>
